...
// Iconos de alta definición
import {
    FiTool, FiActivity, FiClock, FiCheckSquare, FiAlertOctagon,
    FiMenu, FiX, FiArrowLeft, FiEdit2, FiLayers, FiHome
} from 'react-icons/fi';
// Importación solicitada
import Encargos from '../admin/encargos.jsx';
import CargaContenidoWeb from '../admin/cargaDeContenido/cargaDeContenido.jsx';
...
const ServicioTecnico = () => {
    const [seccionActiva, setSeccionActiva] = useState('reparaciones');
    ...
    // --- CONFIGURACIÓN VISUAL FEDECELL (LEGIBILIDAD MAX) ---
    const styles = {
    ...
    const menuItems = [
        { id: 'reparaciones', label: 'ENCARGOS', icon: <FiPackage /> },
        { id: 'web_content', label: 'WEB_CONTENT', icon: <FiEdit2 /> },
    ];

    return (
        <div className={styles.container}>
            <style dangerouslySetInnerHTML={{ __html: FedecellTechStyles }} />
            ...
            <motion.button
                ...
                className="fixed h-[40px] md:h-[45px] top-[20px] md:top-[40px] left-[10px] md:left-[15px] z-[1001] bg-[#ff8c00] text-black p-2 md:p-3 shadow-[0_0_20px_rgba(255,140,0,0.3)] border border-white/10"
            >
            ...
            >
                <div className="p-8 border-b border-white/5 pt-24 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <FiTool className="text-[#ff8c00] text-xl" />
                        <span className="fedecell-tech text-[10px] text-[#ff8c00] font-black tracking-widest">LAB_v2</span>
                    </div>
                </div>
            ...
            >
                <header className={styles.header}>
                    <div className="flex items-center gap-4 mb-2">
                        <FiActivity className="text-[#ff8c00] text-2xl" />
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <div className="md:p-2">
                            {seccionActiva === 'reparaciones' ? <Encargos /> : <CargaContenidoWeb />}
                        </div>
                    </motion.div>
                </AnimatePresence>
