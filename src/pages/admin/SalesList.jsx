      ...
      <div className="divide-y divide-gray-700">
        {productosVendidos.length === 0 ? (
          <div className="p-6 text-center text-gray-500">
            No hay ventas registradas en la caja actual
          </div>
        ) : (
            ...
            >
              ...
              <div className="flex-grow">
                ...
                <div className="mt-1 text-sm text-gray-400 grid grid-cols-2 md:grid-cols-4 gap-2">
                  ...
                  <div>
                    <span className="font-medium text-gray-300">Cantidad:</span>{" "}
                    {producto.cantidad}
                  </div>
                  <div>
              ...
              <div className="mt-4 md:mt-0 flex space-x-3">
                <button
                  onClick={() =>
                    handleEliminarProductoVendido(producto.ProductId)
                  }
