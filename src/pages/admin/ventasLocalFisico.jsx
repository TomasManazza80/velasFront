...
const HistorialVentasLocal = () => {
  ...
  return (
    <div
      className={`${styles.glassCard} p-4 md:p-8 rounded-none text-white selection:bg-white selection:text-gray-900 font-['Inter']`}
    >
      {" "}
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6">
        ...
        <div className="flex items-center">
          ...
          <div>
            {" "}
            <h1 className={`${styles.heading} text-2xl md:text-4xl`}>
              VENTAS LOCAL FÍSICO
            </h1>{" "}
            <p className={`${styles.tech} text-[10px] text-gray-500 mt-2`}>
              HISTORIAL TERMINAL POS
            </p>{" "}
          </div>{" "}
        </div>{" "}
      ...
      {tabActiva === "historial" ? (
        <>
          ...
          <div className="flex items-center bg-black border border-white/10 p-4 mb-8 focus-within:border-white transition-colors">
            {" "}
            <FiSearch className="text-gray-500 mr-4" size={20} />{" "}
            <input
              type="text"
          ...
          <div className="overflow-x-auto border border-white/5 no-scrollbar">
            ...
            <table className="min-w-full divide-y divide-white/5">
              ...
              <thead className="bg-[#0a0a0a]">
                ...
                <tr>
                  {" "}
                  <th className={`px-6 py-5 text-left ${styles.label}`}>
                    ID OPERACIÓN
                  </th>{" "}
                  <th className={`px-6 py-5 text-left ${styles.label}`}>
                    CLIENTE
                  ...
                  <th className={`px-6 py-5 text-right ${styles.label}`}>
                    TOTAL
                  </th>{" "}
                  <th className={`px-6 py-5 text-left ${styles.label}`}>
                    FECHA
              ...
              <tbody className="divide-y divide-white/5">
                ...
                {ventasFiltradas.map((v, i) => (
                  ...
                  >
                    {" "}
                    <td
                      className={`px-6 py-5 text-[10px] ${styles.tech} text-white align-top`}
                    >
                      #{v.id}
                    </td>{" "}
                    ...
                    <td className="px-6 py-5 align-top">
                      ...
                      <div className="space-y-1">
                        ...
                        {(v.productos || []).map((p, idx) => (
                          ...
                          >
                            {" "}
                            <span className="text-gray-600 font-black mr-2">
                              x{p.cantidad}
                            </span>{" "}
                    ...
                    <td
                      className={`px-6 py-5 text-[10px] ${styles.tech} align-top`}
                    >
                      {" "}
                    ...
                    <td
                      className={`px-6 py-5 text-xs font-black ${styles.tech} text-white align-top text-right`}
                    >
                      {" "}
                      {formatearMoneda(v.montoTotal)}{" "}
                    </td>{" "}
                    <td
                      className={`px-6 py-5 text-[9px] ${styles.tech} text-gray-600 align-top`}
                    >
                      {" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {" "}
          <div
            className={`${styles.glassCard} col-span-2 p-8 border-white/5 bg-[#080808]`}
          >
            {" "}
            <h3
              className={`${styles.heading} text-xl mb-8 flex items-center text-white`}
            >
              {" "}
            ...
            <div className="space-y-3">
              ...
              {productosMasVendidos.map((p, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-4 bg-black border border-white/5 hover:border-white/20 transition-all group"
                >
                  {" "}
                  <div className="flex items-center">
                    {" "}
                    <span
                      className={`${styles.tech} text-lg font-black text-zinc-800 mr-5 group-hover:text-white transition-colors tracking-tighter`}
                    >
                      {" "}
                    ...
                    <div>
                      {" "}
                      <p className="text-[11px] font-black uppercase tracking-tight text-zinc-200">
                        {p.nombre}
                      </p>{" "}
                      <p
                        className={`${styles.tech} text-[8px] text-gray-600 mt-1`}
                      >
                        {p.marca}
                      </p>{" "}
                    </div>{" "}
                  ...
                  <div className="text-right">
                    {" "}
                    <p
                      className={`${styles.tech} text-xs font-black text-white`}
                    >
                      {p.cantidad} UDS.
                    </p>{" "}
                    <p
                      className={`${styles.tech} text-[9px] text-gray-500 mt-1`}
                    >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8">
              {" "}
              <FiDollarSign size={40} className="mb-6 text-gray-900" />{" "}
              <h4 className="text-gray-400 font-black text-[9px] uppercase tracking-[0.2em] mb-2">
                VOLUMEN TOTAL LOCAL
              </h4>{" "}
              <p className="text-3xl font-black text-gray-900 leading-none tracking-tighter">
                ...
                {formatearMoneda(
                  ventas.reduce(
                    (acc, v) => acc + parseFloat(v.montoTotal || 0),
                    0,
                  ),
                ).replace(",00", "")}{" "}
              </p>{" "}
