      ...
      <table className="w-full border-collapse mt-3 rounded-lg shadow-lg overflow-hidden border border-gray-700">
        <thead>
          <tr>
            ...
            <th className="py-2 px-3 text-left border-b-2 border-gray-700 bg-gray-800 text-gray-300 font-semibold text-xs rounded-tl-lg">
              Producto
            </th>
            <th className="py-2 px-3 text-left border-b-2 border-gray-700 bg-gray-800 text-gray-300 font-semibold text-xs">
              Marca
            </th>
            <th className="py-2 px-3 text-left border-b-2 border-gray-700 bg-gray-800 text-gray-300 font-semibold text-xs">
              Cantidad
            ...
            <th className="py-2 px-3 text-left border-b-2 border-gray-700 bg-gray-800 text-gray-300 font-semibold text-xs rounded-tr-lg">
              Fecha de Venta
            </th>
          </tr>
        </thead>
        <tbody>
          {ventas.map((venta, index) => {
            ...
            const precioTotal = (precioUnitario * cantidad).toLocaleString(
              "es-AR",
            ...
            return (
              ...
              >
                ...
                <td className="py-2 px-3 text-gray-400 text-xs">
                  ...
                  {venta.fechaCompra
                    ? venta.fechaCompra.substring(0, 10)
                    : "N/A"}
                </td>
              </tr>
            );
...
const HistorialDeVentas = () => {
  ...
  return (
    ...
    >
      ...
      >
        <FiCalendar size={20} className="mr-2 text-[#3b82f6]" /> Historial de
        Ventas | Gestión
      </h2>
      ...
      <div className="flex flex-wrap items-end gap-2 mb-3 p-3 bg-gray-900 border border-gray-700 rounded-md">
        ...
        <span className="text-[9px] text-gray-600 self-end pb-1">
      ...
      {cargando ? (
        ...
        <div className="text-center p-4 bg-gray-900 rounded-lg">
          <FiLoader
            size={20}
            className="text-[#3b82f6] mx-auto mb-2 animate-spin"
          />
        ...
        <>
          ...
          <div className="flex justify-between items-center mb-3 border-b border-gray-700 pb-2 text-xs">
            <p className="text-gray-400 m-0">
              Ítems mostrados:{" "}
              <strong className="text-white">{ventasFiltradas.length}</strong>{" "}
