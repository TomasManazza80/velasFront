      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-white/80 backdrop-blur-md border border-black p-6 rounded relative overflow-hidden group hover:border-[#00E676] transition-colors duration-300">
          ...
          <p className="text-sm md:text-base leading-relaxed mb-5">
            Ahora que tu pago se realizó correctamente, debes mirar en tu
            WhatsApp el mensaje que te enviamos.
          </p>
          ...
          <div className="bg-gray-50 border-l-4 border-[#FF6600] p-4 font-mono text-xs md:text-sm">
            <p className="text-gray-600 mb-2">
              <strong className="text-black">[SOPORTE]:</strong> Si no recibiste
              nada, es posible que hayas escrito mal tu número. Comunícate al:
            </p>
        ...
        <div className="bg-white/80 backdrop-blur-md border border-black p-6 rounded relative overflow-hidden group hover:border-[#00E676] transition-colors duration-300">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            Si el mensaje es el correcto vas a poder ver todos los datos de tu
            compra. Solo deberás esperar a que te llegue o pasar por el local a
            retirarlo.
          </p>
        </div>
      </div>
