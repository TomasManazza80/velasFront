...
const datosMensuales = {
  ...
  data: [1200.5, 1900.75, 3000.0, 5000.25],
};
...
const SalesDashboard = ({ vistaGrafica, setVistaGrafica }) => {
  const datosGraficoActivo =
    vistaGrafica === "mensual" ? datosMensuales : datosSemanales;
  const tituloGraficoActivo =
    vistaGrafica === "mensual" ? "Ventas del Mes" : "Ventas de la Semana";
  ...
  return (
    <div className="mt-8">
      ...
      <div className="w-full">
        <SalesChart
          chartData={datosGraficoActivo}
          title={tituloGraficoActivo}
        />
      </div>
    </div>
  );
