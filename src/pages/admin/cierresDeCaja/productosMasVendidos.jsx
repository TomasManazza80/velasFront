...
const TopVendidos = () => {
  ...
  const procesarDatos = (data) => {
    ...
    const listaOrdenada = Object.values(conteoProductos).sort(
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Análisis de rendimiento basado en recaudación final.
            </p>
          </div>
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="text-sm font-bold text-gray-900">
                      $
                      {producto.totalGenerado.toLocaleString("es-AR", {
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1.5 mt-2 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min((producto.cantidad / productos[0].cantidad) * 100, 100)}%`,
                        }}
                      ></div>
                    </div>
                  </td>
