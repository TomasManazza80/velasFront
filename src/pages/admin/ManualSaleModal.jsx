...
const ManualSaleModal = ({
  ...
  const handleSeleccionProducto = (producto) => {
    ...
    handleVentaManualChange({
      target: { name: "nombre", value: producto.nombre },
    });
    handleVentaManualChange({
      target: { name: "precio", value: producto.precio },
    });
    handleVentaManualChange({
      target: { name: "descripcion", value: producto.descripcion },
    });
    handleVentaManualChange({
      target: { name: "categoria", value: producto.categoria },
    });
    handleVentaManualChange({ target: { name: "cantidad", value: 1 } });
    handleVentaManualChange({
      target: { name: "talle", value: producto.talle },
    });
    handleVentaManualChange({
      target: { name: "marca", value: producto.marca },
    });
    handleVentaManualChange({
      target: { name: "imagenes", value: producto.imagenes },
    });
