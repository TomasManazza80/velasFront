...
const DebtCard = ({ debt, onPay, onDelete }) => {
  ...
  const porcentajePagado = Math.min(
    (debt.montoPagado / debt.montoTotal) * 100,
    100,
  );
    ...
    <div className="bg-[#0A0A0A] border border-white/5 p-10 rounded-2xl shadow-2xl group hover:border-orange-500/30 transition-all">
      ...
      <div className="space-y-4 mb-10">
        <div className="flex justify-between items-end">
          <span className="font-['JetBrains_Mono'] text-[10px] text-zinc-500 uppercase">
            Estado_de_Amortización
          </span>
          <span className="font-['JetBrains_Mono'] text-sm font-black text-orange-500">
      ...
      <div className="grid grid-cols-2 gap-8 py-6 border-y border-white/5">
        <div>
          <p className="font-['JetBrains_Mono'] text-[9px] text-zinc-600 uppercase mb-1">
            Monto_Total
          </p>
        ...
        <div className="text-right">
          <p className="font-['JetBrains_Mono'] text-[9px] text-orange-500 uppercase mb-1">
            Pendiente_Restante
          </p>
