    ...
    >
      <div className="bg-white/[0.02] backdrop-blur-xl p-6 md:p-10 border border-white/10 shadow-2xl text-center">
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <h2 className="font-[900] uppercase tracking-tighter text-2xl text-white">
            WHATSAPP_BRIDGE
          </h2>
        </div>
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="space-y-2">
                <p className="text-xs font-bold uppercase tracking-widest text-white">
                  Iniciando navegador interno...
                </p>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest">
                  Preparando sesión segura // [PUPPETEER_INIT]
                </p>
              </div>
            </motion.div>
          )}

          {(status === "qr" || status === "max_qr_attempts_reached") &&
            qrCode && (
              <motion.div
                key="qr"
          ...
          {status === "connected" && (
            ...
            >
              ...
              <div className="space-y-2">
                <p className="font-[900] text-xl text-white uppercase tracking-tighter">
                  ¡VÍNCULO_ESTABLECIDO!
                </p>
                <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
                  WhatsApp Core System Connected
                </p>
              </div>
            </motion.div>
          )}
          ...
          {(status === "disconnected" ||
            ...
            (status === "max_qr_attempts_reached" && !qrCode)) && (
            <motion.div
              key="error"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
